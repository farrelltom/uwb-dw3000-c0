...
void dw1000_gpio_set_mode(struct _dw1000_dev_instance_t * inst, uint8_t gpioNum, uint8_t mode);
uint8_t dw1000_gpio_get_mode(struct _dw1000_dev_instance_t * inst, uint8_t gpioNum);
...
uint8_t dw1000_gpio_get_direction(struct _dw1000_dev_instance_t * inst, uint8_t gpioNum);
